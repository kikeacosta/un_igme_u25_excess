...
map_this("Infant")
ggsave("figures/figS12_map_psc_inf.png", dpi = 700,
       w = 8,
       h = 3)

map_this("1-4")
ggsave("figures/figS13_map_psc_1-4.png", dpi = 700,
       w = 8,
       h = 3)

map_this("5-9")
ggsave("figures/figS14_map_psc_5-9.png", dpi = 700,
       w = 8,
       h = 3)

map_this("10-14")
ggsave("figures/figS15_map_psc_10-14.png", dpi = 700,
       w = 8,
       h = 3)

map_this("15-19")
ggsave("figures/figS16_map_psc_15-19.png", dpi = 700,
       w = 8,
       h = 3)

map_this("20-24")
ggsave("figures/figS17_map_psc_20-24.png", dpi = 700,
       w = 8,
       h = 3)
