...
# using long format file
  ...
  afro_raw0 <-
    read_xlsx("data_input/HMIS/Continuity of Essential Services - Mortality-longformat 2022-07-22.xlsx")
  
  afro_raw <-
    read_xlsx("data_input/HMIS/Continuity of Essential Services - Mortality-longformat 24-01-15.xlsx")
...
#     temp[[i]] <- 
#       read_xlsx("data_input/HMIS/Continuity of Essential Services - Mortality - KEN, SWZ, BDI, UGA, MWI, ZMB, ZWE-22-03-30.xlsx",
#                 sheet = cts[i]) %>% 
...
#     bind_rows() 
  ...
  unique(afro_raw0$Country) %>% sort
  unique(afro_raw$Country) %>% sort
...
# Other HMIS countries (Bangladesh, Afghanistan, Libia, etc.)
# ====================
{
hmis_raw <- 
  read_xlsx("data_input/HMIS/20220830_Covid analysis data_HMIS.xlsx",
            sheet = 1) 
...
# ==========
{
bts <- read_xlsx("data_input/JHU/COMSA CSA data_2021 09 11-Shared.xlsx",
                 sheet = 1)

sbs_mths <- read_xlsx("data_input/JHU/COMSA CSA data_2021 09 11-Shared.xlsx",
                      sheet = 2,
                      skip = 1)

dts <- read_xlsx("data_input/JHU/COMSA CSA data_2021 09 11-Shared.xlsx",
                 sheet = 3)
...
nga <- 
  read_xlsx("data_input/HMIS/HMIS_data_Nigeria_2015_2021_all_data.xlsx")
...
# =====
{
db <- read_csv("data_input/HMIS/HMIS_data_India_byState_2015_2021.csv")
...
# ==========
{
db_raw <- read_xlsx("data_input/HMIS/HMIS_data_Bangladesh_2017_2021.xlsx")
...
write_rds(all_cts, "data_inter/hmis_all_countries.rds")
