...
table_s1 <- 
  table_s1_v1 %>% 
  select(var, a_2020, a_2021, a_2022, i_2020, i_2021, i_2022) 

table_s1

write_csv(table_s1, "tables/tableS01_crvs_data.csv")
...
table_s2
write_csv(table_s2, "tables/tableS02_hmis_data.csv")
...
table_01
write_csv(table_01, "Tables/table01_included_data.csv")
...
table_S03
write_csv(table_S03, "tables/tableS03_years_data.csv")
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
write_csv(table_S04, "tables/tableS04_sources_data.csv")

# UNICEF sources ====
# ~~~~~~~~~~~~~~~~~~~
uncf <- read_xlsx("data_input/unicef/Table Sources Covid.xlsx")
...
srs_all <- 
  ...
  mutate(source = ifelse(database == "unpd", source_unpd, source), 
         source = case_when(database == "hmis" & Country != "Mozambique" ~ "Health Management Information System (HMIS)", 
                            ...
                            database == "wpp" ~ "UNPD - World Population Pospects 2022 (WPP)", 
...
# write_csv(srs_all, "Tables/tableS05_sources_details.csv")
...
srs_all2 <- 
  ...
  filter(!(measure == "births" & 
             source2 == "UNPD - World Population Pospects 2022 (WPP)" & 
             n == 2)) %>% 
  select(-n, -Code) %>% 
  mutate(Country = case_when(Country == "China, Hong Kong SAR" ~ "Hong Kong - China SAR",
                             Country == "Taiwan" ~ "Taiwan - Province of China",
...
write_csv(srs_all2, "tables/tableS05_sources_details.csv")
