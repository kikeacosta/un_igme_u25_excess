...
sbs_fit2 %>% 
  ...
  theme(legend.position = "bottom",
        ...
        legend.text = element_text(size = tx-2.5),
        legend.title = element_text(size = tx-1.5),
        ...
        axis.text.y = element_text(size = tx - 4.5))

ggsave("figures/01_manuscript/figS08_sbs_neo_pscores.png", 
       dpi = 1000,
       width = 6, height = 6)
...
ggsave("figures/01_manuscript/figS09_age_specific_pscores.png", 
       dpi = 600,
       width = 10, height = 13)
