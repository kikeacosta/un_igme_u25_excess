...
ggsave("figures/01_manuscript/fig02_map_years.png", dpi = 700,
       w = 8,
       h = 5)
# ggsave("Figures/01_manuscript/fig02_map_years.pdf",
#        w = 8,
#        h = 4)
...
ggsave("figures/01_manuscript/figS01_map_bts_sbs.png",
       dpi = 700,
       w = 8,
       h = 2.7)
...
ggsave("figures/01_manuscript/figS02_map_neo_inf.png",
       dpi = 700,
       w = 8,
       h = 2.7)
...
ggsave("figures/01_manuscript/figS03_map_5y_ages_years.png", dpi = 700,
       w = 8,
       h = 4)
}
...
ggsave("figures/01_manuscript/figS04_map_income.png", dpi = 700,
       w = 8,
       h = 4)
