...
# ~~~~~~~~~~~~~~~~~~~~~~~~
# manuscript R&R using updated estimates merged on Jan15 2024
all_fit <- 
  read_rds("data_output/preliminary_pscores_2024-01-15.rds") 
...
# ggsave("Figures/reports_2023/coverage.png",
#        w = 6,
#        h = 3)
