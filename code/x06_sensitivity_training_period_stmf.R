...
plot_example <- function(ct = "Sweden"){
  ...
  ggsave(paste0("figures/period_fitting_estimates_", ct, ".png"),
         w = 10,
         h = 8)
}
plot_example("USA")
...
ggsave("figures/distributions_periods_by_age.png",
       w = 10,
       h = 5)  
...
ggsave("figures/proportions_periods_by_age.png",
       w = 10,
       h = 5)  
...
ggsave("figures/proportions_periods_average_by_age.png",
       w = 10,
       h = 5)  
...
tot_stats %>% 
  ...
  theme(strip.background = element_blank(),
        ...
        axis.text.y = element_text(size = 10, face = "bold"),
        panel.spacing = unit(0.5, "lines"))
ggsave("figures/average_pscores_all_countries_by_age.png",
       w = 8,
       h = 4)  
...
tot_stats %>% 
  ...
  theme(strip.background = element_blank(),
        ...
        panel.spacing = unit(0.5, "lines"))
ggsave("figures/averages_pscores_2020_2022.png",
       w = 8,
       h = 4)  
