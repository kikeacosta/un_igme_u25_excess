...
ggsave("figures/props.png", 
       dpi = 700,
       width = 10, height = 4)


# saving temporary files
write_csv(dts2, "data_output/data_plot_proportions.csv")
write_csv(db_summary, "data_output/table_plot_proportions.csv")
...
pl_dist_inc
ggsave("figures/manuscript/figS09_pscore_distribution_proportions_by_income.png", 
       dpi = 1000,
       width = 7, height = 7)

pl_prop_inc
ggsave("figures/manuscript/figS10_pscore_distribution_proportions_by_income.png", 
       dpi = 1000,
       width = 7, height = 7)
